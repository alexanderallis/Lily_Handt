...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/pages.css">
	<?php
		if( function_exists( 'lily_styles' ) ) :
			echo lily_styles();
		endif;
	?>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="right-header">
			<a href="<?php echo home_url(); ?>" class="right-logo">
